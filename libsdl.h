...
//void				sdl_bline(t_sdlenv env, SDL_Color color, t_bline boldline);
...
//void				sdl_bcircle(t_sdlenv env, SDL_Color color, t_bcircle boldcircle);
void				drawquad_sdl(t_sdlenv env, SDL_Color color, int n_points, ...);
//void				sdl_quad(t_sdlenv env, SDL_Color color, int n_points, ...);
void				drawboldquad_sdl(t_sdlenv env, SDL_Color color, int bold, int n_points, ...);
//void				sdl_bquad(t_sdlenv env, SDL_Color color, int bold, int n_points, ...);
void				drawrect_sdl(t_sdlenv env, SDL_Color color, t_point a, t_point b);
//void				sdl_rect(t_sdlenv env, SDL_Color color, t_point a, t_point b);
		void				drawboldrect_sdl(t_sdlenv env, SDL_Color color, t_bline info);
		//void				sdl_brect(t_sdlenv env, SDL_Color color, t_bline info);
void				drawrect_sdl_b(t_sdlenv env, SDL_Color color, SDL_Rect rect);
//void				sdl_rect_b(t_sdlenv env, SDL_Color color, SDL_Rect rect);
...
//void				sdl_square(t_sdlenv env, SDL_Color color, t_point a, int l);
